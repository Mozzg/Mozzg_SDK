...
begin
  ...
  lHeaderEncoding := nil;
  try
    {$MESSAGE warn 'WARNIGN!!!!  ѕроверить все ветки. —делать дл€ каждой свой xml и грузить их.'}
...
begin
  ...
  begin
    ...
    // +++ исправить параметр NearTextPosition, т.к. после конвертации позици€ неправильна€
